...
/datum/emote/living/raptorscream
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'hrzn/modules/emotes/sound/emotes/raptorscream.ogg'
...
/datum/emote/living/rodentscream
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'hrzn/modules/emotes/sound/emotes/rodentscream.ogg'
...
/datum/emote/living/purr
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'hrzn/modules/emotes/sound/voice/feline_purr.ogg'
...
/datum/emote/living/trills
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'hrzn/modules/emotes/sound/voice/trills.ogg'
...
/datum/emote/living/warble
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'hrzn/modules/emotes/sound/voice/warbles.ogg'
...
/datum/emote/living/felinehiss
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'hrzn/modules/emotes/sound/emotes/felinehiss.ogg'
...
/datum/emote/living/laugh/get_sound(mob/living/user)
	...
	if(isfelinid(user))
		return pick('hrzn/modules/emotes/sound/emotes/nyaha.ogg',
					'hrzn/modules/emotes/sound/emotes/nyahaha1.ogg',
					'hrzn/modules/emotes/sound/emotes/nyahaha2.ogg',
					'hrzn/modules/emotes/sound/emotes/nyahehe.ogg')
	if(iscarbon(user))
		if(user.gender == MALE)
